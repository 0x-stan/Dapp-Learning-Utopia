...
- Developers new to dapp are strongly encoraged to learn the basics of Ethereum and Solidity before embarking on formal development.
  You can refer to [basic knowledge preparation](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/basic-knowledge.md) to ramp up.

**Development tool**

- Sharp tools make good work. Familiarize yourself with basic development tools.
  Refer to [recommended development tools](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/develop-tools.md) to view the current mainstream blockchain development tools.
...
At the same time, feel free to keep expanding this [book list](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/books.md).
...
If you have other high-quality course recommendations, we hope you can make a suggestion and add it in our course repo: [Recommendations for cryptographic courses](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/crypto-course.md).
...
3.  [Compound](defi/Compound/readme.md) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new) ⌛
4.  [Aave](https://docs.aave.com/portal/) ⌛
5.  [SNX](https://github.com/Synthetixio) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
6.  [Curve](defi/Curve/README.md) ⌛
7.  [0x-protocol](defi/0x-protocal/README.md) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
8.  [Bancor](https://bancor.network/) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
9.  [YFI](https://yearn.finance/) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
...
- 1.  [OpenSea](nft/opensea/readme.md) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
- 2.  [aavegotchi](https://aavegotchi.com/) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
- 3.  Loot NFT Distribute

## DAO advanced tasks

- 1.  [Aragon](dao/Aragon/readme.md)
- 2.  Augur [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
- 3.  [DAOHaus](https://daohaus.club/)
- 4.  [DAOstack](https://daostack.io/) [👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
- 5.  [Gnosis](https://github.com/gnosis)[👉 Pick up this task](https://github.com/Dapp-Learning-DAO/Dapp-Learning/issues/new)
...
Dapp-learning has a series of derivative projects and joint maintenance projects. Refer to [related projects](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/relative-projects.md),Learn more about the ecology of the Dapp-Learning project.

## Guide to Contribution

Intereted in participating? Check out this doc and find out how you can be a member of us: [How to contribute](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/dao.md).

## Frequently Asked Questions (FAQ)

Please refer to [this link](https://github.com/Dapp-Learning-DAO/Dapp-Learning/tree/main/docs/TROUBLE_SHOOTING.md) to get some answers on how to set up dev environment, how to use the project, and how to get tokens for testing etc.
